// 用法: node tools/fetch-batch4micro.mjs — 9 个复核/重试
...
const JOBS = [
  ...
  { id: 'scientific-revolution', search: 'Magdeburg hemispheres engraving' },
  ...
  { id: 'li-si', search: 'Xiaozhuan script Qin' },
  { id: 'sima-xiangru', search: 'Sima Xiangru portrait' },
