// 用法: node tools/fetch-batch4final.mjs — 最后 7 个，12 秒延时
...
const JOBS = [
  { id: 'indus', search: 'Mohenjo-daro stupa' },
  { id: 'cervantes-shakespeare', wiki: 'Miguel de Cervantes' },
  { id: 'voyages-of-zhenghe', check: 'Voyages of Zheng He.png' },
  { id: 'jingkang-incident', search: 'Huizong emperor portrait' },
  { id: 'xinhai-revolution', search: 'Xinhai Revolution' },
  { id: 'reformation', search: 'Martin Luther Cranach portrait' },
  { id: 'x-ray-discovery', search: 'Rontgen hand radiograph' },
]
